...
filename = sys.argv[1]
data = np.loadtxt(filename,delimiter=',',skiprows=1,usecols=(1,2,3,4,5,6)).T
...
ax[1][1].plot(data[4], "ro-", label="TPCH3")
ax[2][0].plot(data[5], "ro-", label="Page Rank")
try:
...
ax[1][1].set_title("TPCH3")
ax[2][0].set_title("Page Rank")
