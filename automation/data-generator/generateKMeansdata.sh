...
python data-generator/KMeansDataGenerator.py 3 8 $NUM1 $FILES_KMEANS_LOW_GEN_POINT $FILES_KMEANS_LOW_GEN_CENTER

echo "Generating Data that is required for running the tasks: Dimension=1000, K=800, NUM=$NUM2"

python data-generator/KMeansDataGenerator.py 1000 800 $NUM2 $FILES_KMEANS_HIGH_GEN_POINT $FILES_KMEANS_HIGH_GEN_CENTER
