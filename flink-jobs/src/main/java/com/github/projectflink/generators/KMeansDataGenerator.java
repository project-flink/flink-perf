...
/**
 * Generates data for KMeans. Not distributed
 */
public class KMeansDataGenerator {
	...
	public static void main(String[] args) throws IOException {
		...
		if (args.length < 2) {
			System.out.println("KMeansDataGenerator <numberOfDataPoints> <numberOfClusterCenters> [dimensionality] [outDir] [<relative stddev>] [<centroid range>] [<seed>]");
			System.exit(1);
		}
		...
		final int dimensionality = args.length > 2 ? Integer.parseInt(args[2]) : 2;
		final String outDir = args.length > 3 ? args[3] : System.getProperty("java.io.tmpdir");
