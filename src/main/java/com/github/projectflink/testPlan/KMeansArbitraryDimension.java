...
public class KMeansArbitraryDimension {
	...
	public static final class ConvertToPoint extends MapFunction<String, Point> {
	...
	public static final class ConvertToCentroid extends MapFunction<String, Centroid> {
