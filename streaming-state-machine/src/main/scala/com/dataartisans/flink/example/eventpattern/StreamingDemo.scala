...
import org.apache.flink.streaming.connectors.kafka.{FlinkKafkaConsumer082, FlinkKafkaConsumer}
...
object StreamingDemo {
  ...
  /*  props.put("auto.offset.reset", "smallest")
   ...
   val stream = env.addSource(new FlinkKafkaConsumer082[Event](pt.getRequired("topic"), new EventDeSerializer() ,props))
